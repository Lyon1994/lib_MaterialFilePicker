...
import org.lyon_yan.app.android.lib_materialfilepicker.utils.FileUtils;
...
public class FilePickerActivity extends AppCompatActivity implements
        DirectoryFragment.FileClickListener, DirectoryFragment.FolderLongClickListener {
    private static final String ARG_CURRENT_PATH = "arg_title_state";
    public static final String RESULT_FILE_PATH = "result_file_path";
    private static String START_PATH = Environment
     ...
     * @param sTART_PATH
     * @author Lyon_Yan <br/>
     * <b>time</b>: 2015年12月2日 下午12:32:40
     */
    public static void setSTART_PATH(String sTART_PATH) {
     ...
     * @return
     * @author Lyon_Yan <br/>
     * <b>time</b>: 2015年12月2日 下午12:32:44
     */
    public static String getSTART_PATH() {
        return START_PATH;
    }
    ...
    private void updateTitle() {
        if (getSupportActionBar() != null) {
            String title = mCurrentPath.isEmpty() ? "sdcard" : mCurrentPath;
    ...
    private boolean handleFolderLongClicked(final File longCickedFolder) {
        setResultAndFinish(longCickedFolder.getPath());
        return false;
    }

    @Override
    public boolean onFolderLongClicked(File longCickedFolder) {
        return handleFolderLongClicked(longCickedFolder);
    }
}
